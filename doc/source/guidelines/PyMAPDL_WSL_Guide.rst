...
We recommend that you install WSL2 rather than WSL1. 
...
You can install it using an unofficial WSL distribution hosted at `<https://github.com/wsldl-pg/CentWSL/>`_ .
